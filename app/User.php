...
class User extends BaseModel implements AuthenticatableContract, CanResetPasswordContract
{
    ...
    protected $fillable = [
        'name', 'email', 'password', 'mobile', 'login', 'status', 'image', 'gender', 'locale', 'onesignal_player_id', 'email_notifications', 'country_id','sync_token','refresh_token','drive_access_token'
    ];
