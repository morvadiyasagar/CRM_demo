...
$this->gclient = $calclient;
    ...
    public function update(StoreTask $request, $id)
    {
        ...
        if ((session()->get('access_token') !="") && session()->get('access_token')) {
            ...
            $event = new Google_Service_Calendar_Event([
                ...
                'end' => ['date' =>  Carbon::createFromFormat($this->global->date_format, $request->due_date)->format('Y-m-d')],
    ...
    {
        $task = Task::findOrFail($id);
        $projectinfo=Task::where('id',$id)->first();
    ...
    public function create()
    {
        ...
        return redirect('admin/logintaskgoogle');
    }
    }
    ...
    public function store(StoreTask $request)
    {
        ...
        $task = new Task();
        $task->heading = $request->title;
        $task->cal_event_id = $cal_event_id;
        if ($request->description != '') {
            $task->description = $request->description;
        }
    ...
    //for redirck in to google sceen in for permission
    public function logingoogleproject(){
       
    

        $rurl = url('/admin/logintaskgoogle');
