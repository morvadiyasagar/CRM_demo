                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select name="irpf" id="irpf" class="form-control select2">
                                        <option value="0" @if($company->irpf == '0') selected @endif >
                                            N/A
                                        </option>
                                        <option value="7"
                                                @if($company->irpf == '7') selected @endif >7
                                        </option>
                                        <option value="15"
                                                @if($company->irpf == '15') selected @endif > 15
                                        </option>
                                    </select>
                                </div>
                            </div>
