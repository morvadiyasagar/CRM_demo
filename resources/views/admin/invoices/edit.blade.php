                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-offset-9 col-md-1 text-right p-t-10">
                                            @lang('modules.invoices.irpf')
                                        </div>
                                        
                                        <div class="form-group col-xs-6 col-md-1" >
                                            <select class="form-control" name="irpf" id="irpf">

                                                <option   @if($invoice->irpf == '0') selected @endif value="0">N/A</option>
                                                <option  @if($invoice->irpf == '7') selected @endif value="7">7</option>
                                                <option  @if($invoice->irpf == '15') selected @endif value="15">15</option>
                                            </select>
                                        </div>
                                    </div>
...
<script>
    ...
    $('#updatePayments').on('change','.type, #discount_type,#irpf', function () {
        var quantity = $(this).closest('.item-row').find('.quantity').val();
    ...
    function calculateTotal()
    {
        ...
        if(irpf >0){
            total = parseFloat(total - ((parseFloat(subtotal)/100)*parseFloat(irpf)));
            }
