...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            ...
            <a href="{{url('admin/logingoogle')}}" class="btn btn-sm btn-success btn-outline waves-effect waves-light">
                    <i class="ti-plus"></i> @lang('modules.events.logingoogle')
                </a>
            <ol class="breadcrumb">
    ...
    $('.save-event').click(function () {
        $.easyAjax({
            ...
            success: function (response) {
                if(response==500){
                    location.href="{{url('/admin/logingoogle')}}";
                }
                if(response.status == 'success'){
                   // window.location.reload();
                   location.href="{{url('/admin/events')}}";
                }
            }
        })
    })
