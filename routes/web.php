    ...
    Route::group(
        ...
        function () {
            Route::group(['middleware' => ['account-setup', 'license-expire']], function () {
                ...
                Route::get('/dashboard/callback', 'AdminDashboardController@handleProviderGoogleCallback');
//                Route::post('/dashboard/widget', 'AdminDashboardController@widget')->name('dashboard.widget');
                ...
                Route::get('login/google', 'ManageClientsController@redirectToGoogleProvider');

                Route::get('login/google/callback', 'ManageClientsController@handleProviderGoogleCallback');
                ...
                Route::get('logingoogleproject', 'ManageProjectsController@logingoogleproject');
                Route::get('admin/projects/oauth', ['uses' => 'ManageProjectsController@oauth'])->name('oauthCallback');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::get('logintaskgoogle', 'ManageAllTasksController@logintaskgoogle');
                ...
                Route::get('logingoogle', 'AdminEventCalendarController@logingoogle');
    ...
    Route::resource('document', 'Admin\DocumentController',['except' => ['create']]);
    Route::get('getclientproject', 'Admin\DocumentController@getclientproject');
    Route::get('getprojectfiles', 'Admin\DocumentController@getprojectfiles');
    Route::get('downloadfile/{id}', 'Admin\DocumentController@downloadfile');
